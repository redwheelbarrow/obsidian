...
package com.github.redwheelbarrow;
...
import com.github.redwheelbarrow.Obsidian;
import com.github.redwheelbarrow.Obsidian.Diff;
import com.github.redwheelbarrow.Obsidian.LinesToCharsResult;
import com.github.redwheelbarrow.Obsidian.Patch;

public class ObsidianTest {

  private Obsidian dmp;
  private Obsidian.Operation DELETE = Obsidian.Operation.DELETE;
  private Obsidian.Operation EQUAL = Obsidian.Operation.EQUAL;
  private Obsidian.Operation INSERT = Obsidian.Operation.INSERT;
  ...
  @Test
  public void DiffCleanupSemanticLossless() {
  ...
  @Test
  public void DiffCleanupSemantic() {
  ...
  @Test
  public void DiffCleanupEfficiency() {
  ...
  private static String[] diff_rebuildtexts(LinkedList<Diff> diffs) {
    ...
    for (Diff myDiff : diffs) {
      if (myDiff.operation != Obsidian.Operation.INSERT) {
        text[0] += myDiff.text;
      }
      if (myDiff.operation != Obsidian.Operation.DELETE) {
        text[1] += myDiff.text;
      }
    }
    return text;
